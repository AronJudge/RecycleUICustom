package com.wei.liu.recycleuicustom;
...
public class StarDecoration extends RecyclerView.ItemDecoration {
    ...
    public void onDraw(@NonNull Canvas c, @NonNull RecyclerView parent, @NonNull RecyclerView.State state) {
        ...
        if (parent.getAdapter() instanceof com.wei.liu.recycleuicustom.StarAdapter) {
            com.wei.liu.recycleuicustom.StarAdapter adapter = (com.wei.liu.recycleuicustom.StarAdapter) parent.getAdapter();
